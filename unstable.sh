...
docker build --tag k0d3r1s/php-fpm:${VERSION} --tag k0d3r1s/php-fpm:unstable --tag k0d3r1s/php-fpm:8.2.0-dev --squash --compress --no-cache -f Dockerfile.unstable . || exit
